...
(function() {
    ...
    TXLIVE.settings = { autocollected: false, has_storage: false, has_session: false, dynamic: true };
    ...
    function setSettings(options, override) {
        ...
        TXLIVE.settings.sidebar_lang =
            TXLIVE.settings.sidebar_lang || "en";
        ...
        ! function(e,
            t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).DOMPurify = t() }(this, function() {
            var e = Object.hasOwnProperty,
                ...
                l = a.apply,
                c = a.construct;
            l || (l = function(e, t, n) { return e.apply(t, n) }), r || (r = function(e) { return e }), o || (o = function(e) { return e }), c || (c = function(e, t) {
                return new(Function.prototype.bind.apply(e, [null].concat(function(e) { if (Array.isArray(e)) { for (var t = 0, n = Array(e.length); t < e.length; t++) n[t] = e[t]; return n } return Array.from(e) }(t))))
            });
            ...
            function T(e) { return function(t) { for (var n = arguments.length, r = Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++) r[o - 1] = arguments[o]; return l(e, t, r) } }

            function A(e, r) { t && t(e, null); for (var o = r.length; o--;) { var i = r[o]; if ("string" == typeof i) { var a = p(i);
                        a !== i && (n(r) || (r[o] = a), i = a) }
                    e[i] = !0 } return e }

            function x(t) { var n = i(null),
                    r = void 0; for (r in t) l(e, t, [r]) && (n[r] = t[r]); return n }
            var S = r(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas",
                    ...
                    "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"
                ]),
                k = r(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "audio", "canvas", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path",
                    "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "video", "view", "vkern"
                ]),
                ...
                D = r(["math",
                    "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover"
                ]),
                E = r(["#text"]),
                L = r(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "controlslist",
                    ...
                    "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "xmlns"
                ]),
                w = r(["accent-height", "accumulate", "additive", "alignment-baseline", "ascent", "attributename", "attributetype", "azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clippathunits", "clip-path",
                ...
                M = r(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display",
                ...
                O = r(["xlink:href", "xml:id", "xlink:title",
                ...
                z = o(/^(?:\w+script|data):/i),
                I = o(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
                j = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) { return typeof e } : function(e) {
            ...
            var P = function() { return "undefined" == typeof window ? null : window },
                W = function(e, t) {
                    ...
                    var r = "dompurify" + (n ? "#" + n : "");
                    try {
                        return e.createPolicy(r, { createHTML: function(e) { return e } })
                    } catch (e$0) { return console.warn("TrustedTypes policy " + r + " could not be created."), null }
                };
            return function e() {
                ...
                var o = t.document,
                    ...
                    s = t.NodeFilter,
                    T = t.NamedNodeMap,
                    B = void 0 === T ? t.NamedNodeMap || t.MozNamedAttrMap :
                    T,
                    G = t.Text,
                    q = t.Comment,
                    K = t.DOMParser,
                    V = t.trustedTypes;
                if ("function" == typeof l) { var Y = i.createElement("template");
                ...
                var X = W(V, o),
                    ...
                    ne = o.importNode,
                    re = {};
                try { re = x(i).documentMode ? i.documentMode : {} } catch (e$1) {}
                var oe = {};
                ...
                var ie = N,
                    ...
                    Ue = function(e) {
                        Ie && Ie === e || (e && "object" === (void 0 === e ? "undefined" : j(e)) || (e = {}), e = x(e), fe = "ALLOWED_TAGS" in e ? A({}, e.ALLOWED_TAGS) : pe, me = "ALLOWED_ATTR" in e ? A({}, e.ALLOWED_ATTR) : ye, He = "ADD_URI_SAFE_ATTR" in e ? A(x(ze), e.ADD_URI_SAFE_ATTR) : ze, Fe = "ADD_DATA_URI_TAGS" in e ? A(x(Ce), e.ADD_DATA_URI_TAGS) : Ce, he = "FORBID_TAGS" in e ? A({}, e.FORBID_TAGS) : {}, ge = "FORBID_ATTR" in
                    ...
                    Pe = function(e) { f(n.removed, { element: e }); try { e.parentNode.removeChild(e) } catch (t$2) { e.outerHTML = $ } },
                    We = function(e,
                        t) { try { f(n.removed, { attribute: t.getAttributeNode(e), from: t }) } catch (e$3) { f(n.removed, { attribute: null, from: t }) }
                        t.removeAttribute(e) },
                    Be = function(e) {
                        var t = void 0,
                            n = void 0;
                        ...
                        try { t = (new K).parseFromString(o, "text/html") } catch (e$4) {}
                        if (!t || !t.documentElement) { var a = (t = J.createHTMLDocument("")).body;
                            a.parentNode.removeChild(a.parentNode.firstElementChild), a.outerHTML = o }
                        return e && n && t.body.insertBefore(i.createTextNode(n),
                            t.body.childNodes[0] || null), ee.call(t, xe ? "html" : "body")[0]
                    },
                    Ge = function(e) { return Q.call(e.ownerDocument || e, e, s.SHOW_ELEMENT | s.SHOW_COMMENT | s.SHOW_TEXT, function() { return s.FILTER_ACCEPT }, !1) },
                    qe = function(e) { return !(e instanceof G || e instanceof q) && !("string" == typeof e.nodeName && "string" == typeof e.textContent && "function" == typeof e.removeChild && e.attributes instanceof B && "function" == typeof e.removeAttribute && "function" == typeof e.setAttribute && "string" == typeof e.namespaceURI) },
                    Ke = function(e) {
                        return "object" ===
                            (void 0 === c ? "undefined" : j(c)) ? e instanceof c : e && "object" === (void 0 === e ? "undefined" : j(e)) && "number" == typeof e.nodeType && "string" == typeof e.nodeName
                    },
                    Ve = function(e, t, r) { oe[e] && u(oe[e], function(e) { e.call(n, t, r, Ie) }) },
                    Ye = function(e) {
                        var t = void 0;
                        if (Ve("beforeSanitizeElements", e, null), qe(e)) return Pe(e), !0;
                        if (m(e.nodeName, /[\u0080-\uFFFF]/)) return Pe(e), !0;
                        var r = p(e.nodeName);
                        if (Ve("uponSanitizeElement", e, { tagName: r, allowedTags: fe }), ("svg" === r || "math" === r) && 0 !== e.querySelectorAll("p, br").length) return Pe(e), !0;
                        ...
                        if (!fe[r] || he[r]) { if (Me && !Re[r] && "function" == typeof e.insertAdjacentHTML) try { var o = e.innerHTML;
                                e.insertAdjacentHTML("AfterEnd", X ? X.createHTML(o) : o) } catch (e$5) {}
                            return Pe(e), !0 }
                        return "noscript" !== r && "noembed" !== r || !v(/<\/no(script|embed)/i, e.innerHTML) ? (Ae && 3 === e.nodeType && (t = e.textContent, t = y(t, ie, " "), t = y(t, ae, " "), e.textContent !== t && (f(n.removed, { element: e.cloneNode() }), e.textContent = t)), Ve("afterSanitizeElements", e, null), !1) : (Pe(e), !0)
                    },
                    Xe = function(e, t, n) { if (we && ("id" === t || "name" === t) && (n in i || n in je)) return !1; if (be && v(le, t));
                        else if (ve && v(ce, t));
                        else { if (!me[t] || ge[t]) return !1; if (He[t]);
                            else if (v(de, y(n, ue, "")));
                    ...
                    $e = function(e) {
                        var t = void 0,
                            ...
                            o = void 0,
                            i = void 0;
                        Ve("beforeSanitizeAttributes",
                            e, null);
                        var a = e.attributes;
                        if (a) {
                            var l = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: me };
                            for (i = a.length; i--;) { var c = t = a[i],
                                    s = c.name,
                                    u = c.namespaceURI; if (r = g(t.value), o = p(s), l.attrName = o, l.attrValue = r, l.keepAttr = !0, l.forceKeepAttr = void 0, Ve("uponSanitizeAttribute", e, l), r = l.attrValue, !l.forceKeepAttr && (We(s, e), l.keepAttr))
                                    if (v(/\/>/i, r)) We(s, e);
                                    else { Ae && (r = y(r, ie, " "), r = y(r, ae, " ")); var f = e.nodeName.toLowerCase(); if (Xe(f, o, r)) try { u ? e.setAttributeNS(u, s, r) : e.setAttribute(s, r), d(n.removed) } catch (e$6) {} } }
                            Ve("afterSanitizeAttributes",
                                e, null)
                        }
                    },
                    Ze = function e(t) { var n = void 0,
                            r = Ge(t); for (Ve("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) Ve("uponSanitizeShadowNode", n, null), Ye(n) || (n.content instanceof a && e(n.content), $e(n));
                ...
                return n.sanitize = function(e, r) {
                    ...
                    if (!n.isSupported) { if ("object" === j(t.toStaticHTML) || "function" == typeof t.toStaticHTML) { if ("string" == typeof e) return t.toStaticHTML(e); if (Ke(e)) return t.toStaticHTML(e.outerHTML) } return e }
                    ...
                    if (_e) { if (De)
                        ...
                        else d = i; return Ee && (d = ne.call(o, d, !0)), d }
                    var p = xe ? i.outerHTML : i.innerHTML;
                    return Ae && (p = y(p, ie, " "), p = y(p, ae, " ")), X && Le ? X.createHTML(p) : p
                }, n.setConfig = function(e) { Ue(e), Se = !0 }, n.clearConfig = function() { Ie = null, Se = !1 }, n.isValidAttribute = function(e,
                    t, n) { Ie || Ue({}); var r = p(e),
                        o = p(t); return Xe(r, o, n) }, n.addHook = function(e, t) { "function" == typeof t && (oe[e] = oe[e] || [], f(oe[e], t)) }, n.removeHook = function(e) { oe[e] && d(oe[e]) }, n.removeHooks = function(e) { oe[e] && (oe[e] = []) }, n.removeAllHooks = function() { oe = {} }, n
            }()
        });
    ...
    TXLIVE.logger = {
        serialize: function(obj) { if (typeof obj !== "string")
                if (obj.message) obj = obj.message;
                else try { obj = JSON.stringify(obj) } catch (err) { obj = "" }
                return obj },
        info: function(message) {
            var output =
                "[TXLIVE][INFO] " + TXLIVE.logger.serialize(message);
            if (window.liveSettings.debug && console && console.log) console.log(output);
            return output
        },
        debug: function(message) { var output = "[TXLIVE][DEBUG] " + TXLIVE.logger.serialize(message); if (window.liveSettings.debug && console && console.log) console.log(output); return output },
    ...
    function showDom() {
        try {
            ...
            if (el && el.length) {
                var i = el.length;
                while (i--) el[i].className =
                    (el[i].className || "").replace(/(?:^|\s)txlive(?!\S)/g, "")
            }
        } catch (err) { TXLIVE.logger.error(err) }
    }
    ...
    function bindReady(handler) {
            ...
            if (document.documentElement.doScroll && !isFrame) {
                var tryScroll = function() {
                    ...
                    try {
                        ...
                        ready()
                    } catch (e$7) { setTimeout(tryScroll, 10) }
                };
                tryScroll()
            }
        ...
        if (window.addEventListener) window.addEventListener("load", ready, false);
            ...
            window.onload = function() { if (fn) fn();
                ready() } }
    }
    ...
    function callFunctionArray(fcallarray, param) { if (!fcallarray) return; var is_dynamic_on = TXLIVE.isDynamicPageOn();
        TXLIVE.dynamicPageOff(); for (var i = 0; i < fcallarray.length; ++i) try { fcallarray[i](param) } catch (err) { TXLIVE.logger.error(err) }
        if (is_dynamic_on) TXLIVE.dynamicPageOn() }

    function removeFromFunctionArray(fcallarray, fcall) { if (!fcallarray) return; try { var index = fcallarray.indexOf(fcall); if (index >= 0) fcallarray.splice(index, 1) } catch (err) { TXLIVE.logger.error(err) } }
    ...
    TXLIVE_PRIVATE.trim = function(string) { return string.replace(/^\s+|\s+$/g, "") };
    if (!String.prototype.trim) String.prototype.trim = function() { return TXLIVE_PRIVATE.trim(this) };
    ...
    TXLIVE_PRIVATE.getBrowserLocale = function() {
        ...
        if (navigator.languages &&
            ...
            for (i = 0; i < navigator.languages.length; ++i) { code = TXLIVE.normalizeLangCode(navigator.languages[i]); if (TXLIVE.hasLanguageCode(code)) return code;
                code = TXLIVE.matchLanguageCode(navigator.languages[i]); if (code) return code }
        if (navigator.userLanguage) { code = TXLIVE.normalizeLangCode(navigator.userLanguage); if (TXLIVE.hasLanguageCode(code)) return code;
    ...
    function mergeArrays(array1, array2) { var i = array2.length,
            a; while (i--) { a = array2[i]; if (array1.indexOf(a) < 0) array1.push(a) } }

    function removeFromArray(list, value) { var index = list.indexOf(value); if (index != -1) { list.splice(index, 1); return true } return false }

    function encodeString(str) { return str.replace(/\u00a0/g, "&nbsp;") }

    function decodeString(str) { return str.replace(/&nbsp;/g, "\u00a0") }
    TXLIVE_PRIVATE.stripWhitespace = function(str) { if (!str || !str.trim().length) return null; return encodeString(str).replace(/\s+/g, " ").trim() };
    TXLIVE_PRIVATE.removeComments = function(str) { return (str || "").replace(TXLIVE_PRIVATE.removeCommentsRegex, "") };
    TXLIVE_PRIVATE.getElementsByClassName = function(node, classname) { if (!node) return []; var a = []; var re = new RegExp("(^| )" + classname + "( |$)"); var els = node.getElementsByTagName("*"); for (var i = 0, j = els.length; i < j; i++)
            if (re.test(els[i].className)) a.push(els[i]);
        return a };
    TXLIVE_PRIVATE.bindClick = function(node, fn) { if (node.addEventListener) node.addEventListener("click", function() { if (fn) fn(node) });
        else node.attachEvent("onclick", function() { if (fn) fn(node) }) };
    TXLIVE_PRIVATE.hasClass = function(node, cls) { return (" " + node.className + " ").indexOf(" " + cls + " ") >= 0 };
    TXLIVE_PRIVATE.removeClass = function(node, cls) { if (TXLIVE_PRIVATE.hasClass(node, cls)) { var reg = new RegExp("(\\s|^)" + cls + "(\\s|$)");
            node.className = node.className.replace(reg, " ") } };
    TXLIVE_PRIVATE.addClass = function(node,
        cls) { if (!TXLIVE_PRIVATE.hasClass(node, cls) && node.className !== undefined && node.className.baseVal === undefined) node.className = (node.className || "") + " " + cls };
    TXLIVE_PRIVATE.removeNodeByID = function(id) { var element = document.getElementById(id); if (element && element.parentNode) element.parentNode.removeChild(element) };
    TXLIVE_PRIVATE.getClosestByTag = function(el, tag) { tag = tag.toUpperCase();
        do
    ...
    TXLIVE_PRIVATE.constructPath = function(pathname, search) { search = search || "";
        pathname = pathname || ""; if (search && search[0] === "?") { search = search.substr(1); var search_params = search.split("&"); var index = search_params.indexOf(SIDEBAR_URL_TRIGGER); if (index != -1) search_params.splice(index, 1);
            search = search_params.join("&"); if (search) search = "?" + search } return pathname + search };
    TXLIVE_PRIVATE.getWindowLocation = function() { return window.location };
    TXLIVE_PRIVATE.getWindowPath = function() {
        return TXLIVE_PRIVATE.constructPath(window.location.pathname,
            window.location.search)
    };
    TXLIVE_PRIVATE.getWindowHost = function() { return document.location.host };
    TXLIVE_PRIVATE.isGoogleTranslated = function() { return document.documentElement && document.documentElement.className && document.documentElement.className.match("translated-") };
    TXLIVE_PRIVATE.xssProtect = function(html) { if (TXLIVE.settings.xss_protect) return TXLIVE_PRIVATE.DOMPurify.sanitize(html);
        else return html };
    TXLIVE.doCORSRequest = function(url, method, data, callback, errback) {
        ...
        if (window.XMLHttpRequest) {
            req =
                new XMLHttpRequest;
            if ("withCredentials" in req) { req.open(method, url, true); if (errback) req.onerror = function(err) { if (invoke_cb && errback) errback(err);
                    invoke_cb = false };
                req.onreadystatechange = function() { if (req.readyState === 4 && invoke_cb) { if (req.status >= 200 && req.status < 400) { if (callback) callback(req.responseText) } else if (errback) errback(new Error("doCORSRequest failed with status " + req.status + " for: " + TXLIVE_PRIVATE.getWindowLocation().href), req.status);
                        invoke_cb = false } };
                req.send(data) }
            ...
            req =
                new XDomainRequest;
            req.open(method, url);
            if (errback) req.onerror = function(err) { if (invoke_cb && errback) errback(err);
                invoke_cb = false };
            req.onload = function() { if (invoke_cb && callback) callback(req.responseText);
                invoke_cb = false };
            req.send(data)
    ...
    TXLIVE_PRIVATE.md5 = function() {
        ...
        var wordToHex = function(lValue) { var WordToHexValue = "",
                WordToHexValueTemp = "",
                lByte, lCount; for (lCount = 0; lCount <= 3; lCount++) { lByte = lValue >>> lCount * 8 & 255;
                WordToHexValueTemp = "0" + lByte.toString(16);
                WordToHexValue = WordToHexValue + WordToHexValueTemp.substr(WordToHexValueTemp.length - 2, 2) } return WordToHexValue };
        var uTF8Encode = function(string) { string = string.replace(/\x0d\x0a/g, "\n"); var output = ""; for (var n = 0; n < string.length; n++) { var c = string.charCodeAt(n); if (c < 128) output += String.fromCharCode(c);
                else if (c > 127 && c < 2048) { output += String.fromCharCode(c >> 6 | 192);
    ...
    function _storage_set_emu(key, value) { tx_local_storage[key] = value }

    function _storage_get_emu(key) { return tx_local_storage[key] }
    ...
    function _storage_get_localStorage(key) { try { var value = window.localStorage.getItem(key); if (value) return JSON.parse(value); return null } catch (err) { TXLIVE.logger.error(err); return _storage_get_emu(key) } }

    function _storage_set_sessionStorage(key, value) { try { window.sessionStorage.setItem(key, JSON.stringify(value)) } catch (err) { TXLIVE.logger.error(err);
            _storage_set_emu(key, value) } }
    ...
    function _storage_get_sessionStorage(key) {
        try {
            ...
            return null
        } catch (err) { TXLIVE.logger.error(err); return _storage_get_emu(key) }
    }
    ...
    } catch (err$8) { try { if (window.sessionStorage && window.sessionStorage.setItem) { window.sessionStorage.setItem("txlive", "1");
                TXLIVE_PRIVATE.storage_set = _storage_set_sessionStorage;
                TXLIVE_PRIVATE.storage_get = _storage_get_sessionStorage;
                TXLIVE.settings.has_storage = true } } catch (err) {} }
    try {
    ...
    TXLIVE_PRIVATE.apiScopedKey = function(key) { return TXLIVE.settings.api_key + "@" + key };
    var last_picker_setup = null;

    function setupPicker() { if (last_picker_setup === TXLIVE.settings.picker) return; if (!TXLIVE.settings.picker) return; if (TXLIVE.isPageFiltered()) return; var picker = TXLIVE.settings.picker.trim(); if (!picker.length) return;
    ...
    TXLIVE_PRIVATE.addPicker = function(picker) {
        if (!added_picker_css) {
            ...
            try {
                ...
                head.appendChild(style)
            } catch (err$10) { TXLIVE.logger.error(err$10) }
        }
        try {
            var pick_lang = function(element) { close_picker(); if (element && element.getAttribute) { var lang = element.getAttribute("data-value"); if (lang) TXLIVE.translateTo(lang) } };
            ...
            var open_picker = function() { var toggler = document.getElementById("tx-live-lang-picker"); if (toggler) toggler.className += " " + open_class };
            var is_picker_open = function() { var toggler = document.getElementById("tx-live-lang-picker"); return toggler && toggler.className.indexOf(open_class) >= 0 };
            ...
            if (picker[0] === "#") { var elem = document.getElementById(picker.substr(1)); if (!elem) return;
                elem.innerHTML = TXLIVE_PRIVATE.xssProtect(html) } else {
                var div =
                ...
                switch (picker.toLowerCase()) {
                    case "top-left":
                        csstext += " txlive-langselector-topleft"; break;
                    case "top-right":
                        csstext += " txlive-langselector-topright"; break;
                    case "bottom-left":
                        csstext += " txlive-langselector-bottomleft"; break;
                    case "bottom-right":
                        csstext += " txlive-langselector-bottomright"; break;
                    default:
                        return }
            ...
            if (TXLIVE.getSelectedLanguageCode()) { var langname = TXLIVE.getLanguageName(TXLIVE.getSelectedLanguageCode()); var nameelem = document.getElementById("tx-live-lang-current"); if (langname && nameelem) nameelem.innerHTML = TXLIVE_PRIVATE.xssProtect(langname) }
            var el = document.getElementById("tx-live-lang-toggle");
            var open_class = "txlive-langselector-list-opened";
            if (el) TXLIVE_PRIVATE.bindClick(el, function() { if (is_picker_open()) close_picker();
                else open_picker() });
            el = document.getElementById("tx-live-lang-picker");
            if (el) { el = el.getElementsByTagName("li") || []; for (var j = 0; j < el.length; ++j) TXLIVE_PRIVATE.bindClick(el[j], pick_lang) }
        } catch (err$11) { TXLIVE.logger.error(err$11) }
    };
    ...
    var _parseDecimal = function(value, format) {
        ...
        if (thousands == " ") { thousands = "";
            value = value.replace(/\s/g, "").replace(decimal, "."); return parseFloat(value) }
    ...
    var _formatNumber = function(number, delimiter, decimalDelimiter) { var numberString = number.toString(),
            splitNumber = numberString.split("."),
            splitFloats = ""; if (splitNumber[1]) splitFloats = decimalDelimiter + splitNumber[1]; return splitNumber[0].split(/(?=(?:\d{3})+$)/g).join(delimiter) + splitFloats };
    TXLIVE_PRIVATE.parseDecimal = function(value, format) {
        ...
        if (!spec) { var ret = _parseDecimal(value, ".,"); return !isNaN(ret) ? ret : _parseDecimal(value, ",.") }
        return _parseDecimal(value, spec.group + spec.decimal)
    };
    TXLIVE_PRIVATE.is_locquant = function(node) { var type = node.getAttribute("tx-content"); if (!type || !node.innerHTML) return false;
        type = type.trim().toLowerCase(); if (LOCQUANT_TYPES.indexOf(type) < 0) return false; return type };
    TXLIVE_PRIVATE.process_locquant = function(node) {
        var type = TXLIVE_PRIVATE.is_locquant(node);
        if (!type) return;
        TXLIVE.locquant_segment_list.push({ node: node, type: type, format: node.getAttribute("tx-format"), source_string: node.innerHTML });
        return true
    };
    TXLIVE_PRIVATE.localize_locquant = function(type, text, format) { if (TXLIVE.getSelectedLanguageCode() == TXLIVE.getSourceLanguageCode()) return text; return TXLIVE_PRIVATE["localize_locquant_" + type](TXLIVE.getSelectedLanguageCode(), text, format) };
    ...
    TXLIVE_PRIVATE.localize_locquant_date = function(langcode, text) { return text };
    TXLIVE_PRIVATE.escape_regex = function(string) { return string.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1") };
    TXLIVE_PRIVATE.ignorePath = function(filters, path) {
        if (!filters ||
            !path) return false;
        var i = filters.length;
        while (i--)
            if (filters[i].action == "ignore") { var filter = TXLIVE_PRIVATE._filterToRegexp(filters[i]); var check = filter.neg ? !filter.re.test(path) : filter.re.test(path); if (check) return true }
        return false
    };
    ...
    var PARSER_OPTIONS = { DEFAULT: 1 << 2, DO_NOT_COLLECT: 1 << 1, URLS_AS_VARS: 1 << 2, set: function(value, option) { return value | option }, unset: function(value, option) { return value & ~option }, isset: function(value, option) { return value & option }, isunset: function(value, option) { return !(value & option) } };
    var SKIP_TAGS = {
        SCRIPT: true,
        STYLE: true,
        LINK: true,
    ...
    var SKIP_TAGS_CONTENT = { TEXTAREA: true };
    var SKIP_TAGS_USER = {},
        SKIP_CLASS_USER = {};
    var BLOCK_NODES = {
        ADDRESS: true,
    ...
    function isBlockElement(node) { return node.nodeType === 1 && BLOCK_NODES[node.tagName] === true }

    function isInlineElement(node) { return node.nodeType === 1 && BLOCK_NODES[node.tagName] !== true }

    function isTextElement(node) { return node.nodeType === 3 }

    function isCommentElement(node) { return node.nodeType === 8 }
    ...
    function isSkipTag(tagName) { return tagName && (SKIP_TAGS[tagName] || SKIP_TAGS_USER[tagName]) }

    function isSkipTagContent(tagName) { return tagName && SKIP_TAGS_CONTENT[tagName] }
    ...
    function isSkipAttr(node) { if (!node.getAttribute) return false; var content_attr = node.getAttribute("tx-content"); if (content_attr && content_attr.length) { content_attr = content_attr.toLowerCase(); if (/\bexclude\b/.test(content_attr)) return true } return false }

    function SET_TEXT(item, text) { text = decodeString(text);
        item.node.nodeValue = item.head + text + item.tail }

    function GET_TEXT(item) { return item.node.nodeValue }
    ...
    function SET_FRAGMENT(item, text) {
        ...
        while (node && node != item.snode_after) { var to_delete = node;
            node = node.nextSibling;
            to_delete.parentNode.removeChild(to_delete) }
        var tmp = document.createElement("div");
        tmp.innerHTML = TXLIVE_PRIVATE.xssProtect(item.head +
            text + item.tail);
    ...
    function GET_FRAGMENT(item) { var node = item.snode_before ? item.snode_before.nextSibling : item.snode_after.parentNode.firstChild; var tmp = document.createElement("div"); while (node && node != item.snode_after) { tmp.appendChild(node.cloneNode(true));
            node = node.nextSibling } return tmp.innerHTML }

    function SET_BLOCK(item,
        text) { text = decodeString(text); for (var i = 0; i < item.block_args.length; ++i) { var arg = item.block_args[i]; if (arg.type === "VAR") text = text.replace("{{" + i + "}}", arg.html);
            else if (arg.type === "LQ") text = text.replace("{{" + i + "}}", TXLIVE_PRIVATE.localize_locquant(arg.ltype, arg.inner, arg.format)) }
        item.node.innerHTML = TXLIVE_PRIVATE.xssProtect(item.head + text + item.tail) }

    function GET_BLOCK(item, text) { return item.node.innerHTML }
    ...
    function GET_ATTR(item) { return item.node.getAttribute(item.attribute) }
        ...
        if (node) {
            do
                if (node.nodeType === 1) {
                    ...
                    if (ltype || isSkipTag(node.tagName) || isSkipClass(node.className) || isSkipAttr(node)) { var outerhtml = node.outerHTML; if (outerhtml)
                            if (ltype) args.push({ type: "LQ", html: outerhtml, inner: node.innerHTML, ltype: ltype, format: node.getAttribute("tx-format") });
                            else args.push({ type: "VAR", html: outerhtml }) } else PARSE_ARGS(node.firstChild,
                        args)
                }
    ...
    function PARSE_VARIABLES(text, args, options) {
        if (TXLIVE.settings.variables_parser) text = TXLIVE.settings.variables_parser(text, function(match) { args.push({ type: "VAR", html: match }); return "{{" + (args.length - 1) + "}}" });
        if (/<[a-z][\s\S]*>/i.test(text)) { var node = document.createElement("div");
            node.innerHTML = text;
            PARSE_ARGS(node.firstChild, args); for (var i = 0; i < args.length; ++i)
                if (args[i].type === "VAR" || args[i].type === "LQ") text = text.replace(args[i].html, "{{" + i + "}}") }
        if (PARSER_OPTIONS.isset(options,
                PARSER_OPTIONS.URLS_AS_VARS) && /\s(src|href)/i.test(text)) {
            var match, regex = /(<a[^>]*href\s*=\s*)("[^"]*"|'[^']*')|(<img[^>]*src\s*=\s*)("[^"]*"|'[^']*')/ig;
            var result = "",
                lastIndex = 0;
            while (match = regex.exec(text)) {
                result += text.substring(lastIndex, match.index);
                if (match[2]) { result += match[1] + match[2][0] + "{{" + args.length + "}}" + match[2][0];
                    args.push({ type: "VAR", html: match[2].substring(1, match[2].length - 1) }) } else {
                    result += match[3] + match[4][0] + "{{" + args.length + "}}" + match[4][0];
                    args.push({
                        type: "VAR",
                        html: match[4].substring(1,
                            match[4].length - 1)
                    })
                }
    ...
    function CRAWL_FRAGMENT(snode_before, snode_after, tags, options) {
        ...
        try { if (snode_before) snode_before.txbefore_detected = true; if (snode_after) snode_after.txafter_detected = true } catch (err$12) {}
        var node = document.createElement("div");
        var next = snode_before ?
            snode_before.nextSibling : snode_after.parentNode.firstChild;
        while (next && next != snode_after) { node.appendChild(next.cloneNode(true));
        ...
        segment.elements.push({ segment: segment, pnode: (snode_before || snode_after).parentNode, snode_before: snode_before, snode_after: snode_after, set: SET_FRAGMENT, get: GET_FRAGMENT, block_args: args, head: raw_text.indexOf(" ") === 0 ? " " : "", tail: raw_text.indexOf(" ", raw_text.length - 1) >= 0 ? " " : "" });
    ...
    function CRAWL_BLOCK(node, tags, options) {
        ...
        try { node.txblock_detected = true } catch (err$13) {}
        ...
        var segments = TXLIVE.segments;
        var segment = segments[key];
        if (!segment) { segment = { key: key, source_string: text, tags: [], elements: [] };
        ...
        try { node.txsegment = segment } catch (err$14) {}
        if (NEW_SEGMENTS_DICT) NEW_SEGMENTS_DICT[key] = segment
    }

    function CRAWL_TEXT(node, tags, options) {
        if (node.txtext_detected === true) return;
        try { node.txtext_detected = true } catch (err$15) {}
        ...
        if (text && text.length && !TXLIVE_PRIVATE.isNotTextualRegex.test(text)) {
            ...
            if (!segment) { segment = { key: key, source_string: text, tags: [], elements: [] };
                segments[key] = segment }
            if (tags.length) mergeArrays(segment.tags, tags);
            segment.elements.push({ segment: segment, node: node, pnode: node.parentNode, set: SET_TEXT, get: GET_TEXT, head: raw_text.indexOf(" ") === 0 ? " " : "", tail: raw_text.indexOf(" ", raw_text.length - 1) >= 0 ? " " : "" });
            try { node.txsegment = segment } catch (err$16) {}
            if (NEW_SEGMENTS_DICT) NEW_SEGMENTS_DICT[key] = segment
        }
    }
    ...
    function CRAWL_ATTR(node, attr, tags, options) {
        ...
        if (text && text.length && !TXLIVE_PRIVATE.isNotTextualRegex.test(text)) {
            ...
            try { node.txsegment = segment } catch (err$17) {}
            if (NEW_SEGMENTS_DICT) NEW_SEGMENTS_DICT[key] = segment
        }
    }
            ...
            case "META":
                {
                    ...
                    if (name) { name = name.toLowerCase(); if (name === "keywords" || name === "description" || name === "title" || name === "twitter:title" || name === "twitter:description") list.push("content") }
                    var social_tags = node.getAttribute("property");
                    if (social_tags) { social_tags = social_tags.toLowerCase(); if (social_tags === "og:title" || social_tags === "og:description") list.push("content") }
                    var googleplus_tags = node.getAttribute("itemprop");
                    if (googleplus_tags) {
                        googleplus_tags =
                            googleplus_tags.toLowerCase();
                        if (googleplus_tags === "name" || googleplus_tags === "description") list.push("content")
                    }
                    break
                }
            case "INPUT":
                { list.push("placeholder"); var inputtype = node.getAttribute("type"); if (inputtype) { inputtype = inputtype.toLowerCase(); if (inputtype === "button" || inputtype === "reset" || inputtype === "submit") list.push("value");
                        else if (inputtype === "image") { list.push("alt"); if (PARSER_OPTIONS.isunset(options, PARSER_OPTIONS.URLS_AS_VARS)) list.push("src") } } break }
            case "TEXTAREA":
                list.push("placeholder");
                break
        }
        var custom_attr = node.getAttribute("tx-attrs");
        if (custom_attr && custom_attr.length) { custom_attr = custom_attr.split(",");
            i = custom_attr.length; while (i--) { a = custom_attr[i].trim().toLowerCase(); if (a && list.indexOf(a) < 0) list.push(a) } }
        if (TXLIVE.settings.parse_attr) { var parse_attr = TXLIVE.settings.parse_attr; for (i = 0; i < parse_attr.length; ++i) { a = parse_attr[i]; if (list.indexOf(a) < 0) list.push(a) } }
        return list
    }
    ...
    function IS_IN_DOCUMENT(node) { while (node = node.parentNode)
            if (node === document) return true;
        return false }

    function IS_SKIP_PARENT(node) { while (node) { if (node.nodeType === 1)
                if (isSkipTag(node.tagName) || isSkipClass(node.className) || isSkipAttr(node)) return true;
            node = node.parentNode } return false }

    function NODE_HOSTS_SHADOW_DOM(node) { return node.shadowRoot }

    function PARSE_DOM(node, parent_tags,
        options) {
        if (node)
            if (!isSkipTag(node.tagName))
                if (node.nodeType === 3) { if (PARSER_OPTIONS.isunset(options, PARSER_OPTIONS.DO_NOT_COLLECT)) CRAWL_TEXT(node, parent_tags, options) } else if (node.nodeType === 1 && !isSkipClass(node.className)) {
            var tags = parent_tags;
            var tag_attr = node.getAttribute("tx-tags");
            if (tag_attr && tag_attr.length) { tags = parent_tags.slice(0);
                tag_attr = tag_attr.split(","); var i = tag_attr.length; while (i--) { var a = tag_attr[i].trim().toLowerCase(); if (a && a.length && tags.indexOf(a) < 0) tags.push(a) } }
            var content_attr =
            ...
            if (content_attr && content_attr.length) {
                ...
                else if (/\bblock\b/.test(content_attr)) { _options = PARSER_OPTIONS.unset(_options, PARSER_OPTIONS.DO_NOT_COLLECT);
                    is_block = true }
                if (/\bnotranslate_urls\b/.test(content_attr)) _options =
            ...
            if (!is_block && node.childNodes.length) { var all_text_nodes = true; for (var j = node.childNodes.length - 1; j >= 0; --j)
                    if (node.childNodes[j].nodeType !== 3) { all_text_nodes = false; break }
                if (all_text_nodes) is_block = true }
            if (is_block) {
                if (_collect) CRAWL_BLOCK(node,
                    tags, _options)
            } else {
                var childnode = NODE_HOSTS_SHADOW_DOM(node) ? node.shadowRoot.firstChild : node.firstChild;
                while (childnode)
                    if (isBlockElement(childnode)) { PARSE_DOM(childnode, tags, _options);
                        childnode = childnode.nextSibling } else {
                        var nextnode = childnode.nextSibling;
                        if (!nextnode || nextnode && isBlockElement(nextnode)) { PARSE_DOM(childnode, tags, _options);
                            childnode = childnode.nextSibling } else {
                            ...
                            while (snode) { if (isTextElement(snode) && snode.nodeValue && snode.nodeValue.trim().length) has_text = true;
                                else if (!TXLIVE.settings.ignore_databind && hasDataBinding(snode)) { has_databinding = true; break } else if (isBlockElement(snode)) { snode_after = snode; break }
                                snode = snode.nextSibling }
                            if (!has_text || has_databinding)
                                while (childnode && childnode != snode_after) { PARSE_DOM(childnode, tags, _options);
                                    childnode = childnode.nextSibling } else if (snode_before || snode_after) {
                                    if (_collect) CRAWL_FRAGMENT(snode_before, snode_after, tags, _options);
                                    childnode = snode_after
                                } else { if (_collect) CRAWL_BLOCK(node, tags, _options);
                                    childnode = null }
                        }
                    }
            }
    ...
    function REMOVE_NODE(node, children) { if (!node) return; if (node.txsegment) { var elements = node.txsegment.elements; var j = elements.length; while (j--) { var item = elements[j]; if (item.node == node) removeFromArray(elements, item) } }
    ...
    function CLEAR_FLAGS_DOM(node, children) {
        ...
        if (children) { node = node.firstChild; while (node) { CLEAR_FLAGS_DOM(node, children);
                node = node.nextSibling } }
    }
    ...
    TXLIVE.setLocale = function(langcode) {
        ...
        try {
            ...
            if (TXLIVE.settings.rtl_layout) { var dir = TXLIVE.getLanguageDirection(langcode); if (dir == "rtl" || dir == "ltr" && document.dir == "rtl") document.dir = dir }
        } catch (err$20) { TXLIVE.logger.error(err$20) }
    };
    ...
    function resetSegments(langcode) {
        ...
        while (index--) { var s = locquant_segment_list[index];
    ...
    function translateSegments(langcode,
        json) {
        TXLIVE.setSelectedLanguageCode(langcode);
        TXLIVE.dynamicPageOff();
        callFunctionArray(TXLIVE.__onbeforetranslate);
        ...
        var segments = TXLIVE.segments;
        for (key in segments) { s = segments[key];
            string = json[key];
            j = s.elements.length; while (j--) { item = s.elements[j]; try { if (string) { item.set(item, string);
                        item.modified = true } else if (item.modified) { item.set(item, s.source_string);
                        item.modified = false } } catch (err$22) { s.elements.splice(j, 1) } }
            s.translation_string = string || s.source_string }
        var locquant_segment_list =
            TXLIVE.locquant_segment_list,
            index = locquant_segment_list.length;
        while (index--) { s = locquant_segment_list[index];
    ...
    function autocollectConsume() {
        if (!TXLIVE.autocollect_ready ||
            !autocollect_queue.length || autocollect_processing) return;
        var source_lang = TXLIVE.getSourceLanguageCode() || "";
        var target_lang = TXLIVE.getSelectedLanguageCode() || "";
        if (!TXLIVE_PRIVATE.manifest_ready) { setTimeout(autocollectConsume, 2E3); return }
        if (source_lang !== target_lang) { autocollect_queue.length = 0; return }
        var json = autocollect_queue.shift();
        autocollect_processing = true;
        TXLIVE.doCORSRequest(TXLIVE.settings.autocollect_url, "POST", JSON.stringify(json), function() { autocollect_processing = false;
                autocollectConsume() },
            function(err, status_code) { autocollect_processing = false; if (status_code !== 0 && status_code !== 404) TXLIVE.logger.error(err);
                autocollectConsume() })
    }
    ...
    function autoCollect(custom_segments) {
        ...
        try {
            var segments =
                custom_segments || TXLIVE.segments,
                new_entities = {},
                refresh_ts = [],
                found = false,
                published_keys = LAST_TRANSLATION_JSON || {};
            for (var key in segments) { var s = segments[key]; if (!s.source_string) continue; var collected = key in published_keys; if (collected) refresh_ts.push(key);
                else new_entities[key] = { string: s.source_string, tags: s.tags };
                found = true }
            if (!found) return;
            var json = {
            ...
            autocollectConsume()
        } catch (err$23) { TXLIVE.logger.error(err$23) }
    }
    var mutation_nodes = [],
        observer = null,
    ...
    function __proc_mutations__() {
        if (TXLIVE_PRIVATE.isGoogleTranslated()) { mutation_nodes = []; return }
        var node_list = [];
    ...
    function __dom_inserted_cb(e) { mutation_nodes.push(e.target);
        __proc_mutations__() }

    function __dom_removed_cb(e) { REMOVE_NODE(e.target) }
    ...
    function __observer_inserted_cb(mutations) {
        mutations.forEach(function(mutation) {
            if (mutation.target) {
                ...
                if (mutation.target.childNodes.length || mutation.type ==
                    "attributes") mutation_nodes.push(mutation.target);
                else if (isTextElement(mutation.target) && mutation.target.parentNode) { REMOVE_NODE(mutation.target.parentNode);
                    mutation_nodes.push(mutation.target.parentNode) }
            }
        });
        if (mutation_nodes.length) __proc_mutations__()
    }
    TXLIVE.isDynamicPageOn = function() { return mutators_on };
    TXLIVE.dynamicPageOn = function() {
        ...
        else { document.addEventListener("DOMNodeInserted", __dom_inserted_cb, false);
            document.addEventListener("DOMNodeRemoved", __dom_removed_cb, false) }
    };
    TXLIVE.dynamicPageOff = function() { if (!mutators_initialized || !mutators_on) return;
        mutators_on = false; if (observer) observer.disconnect();
        else { document.removeEventListener("DOMNodeInserted", __dom_inserted_cb);
    ...
    function __destroy_mutators__() { TXLIVE.dynamicPageOff();
        mutators_initialized = false;
        observer = null }
    TXLIVE.normalizeLangCode = function(langcode) {
        ...
        if (langcode.indexOf("_") >= 0) { tokens = langcode.split("_");
            lang = tokens[0].toLowerCase();
            country = tokens[1].toUpperCase();
            langcode = lang + "_" + country } else langcode = langcode.toLowerCase();
        if (extra) langcode += "@" + extra;
        return langcode
    };
    TXLIVE.hasTargetLanguage = function(langcode) { if (!TXLIVE.languages) return false; var languages = TXLIVE.languages; for (var i = 0; i < languages.translation.length; ++i)
    ...
    TXLIVE.translateTo = function(langcode) {
        ...
        try {
            ...
            if (!langcode) { __ready__(); return }
            var languages = TXLIVE.languages;
            if (TXLIVE.getSelectedLanguageCode() === langcode)
                if (languages.source.code === langcode && !LAST_TRANSLATION_LANG || LAST_TRANSLATION_LANG && LAST_TRANSLATION_JSON && LAST_TRANSLATION_LANG === langcode) { __ready__(); return }
            if (languages.source.code === langcode) {
                ...
                for (var i = 0; i < languages.translation.length; ++i)
                    if (languages.translation[i].code === langcode) { lang_url = languages.translation[i].url; break }
                if (!lang_url && !LOCAL_TRANSLATION_STORAGE[langcode]) { __ready__(); return }
                ...
                if (json) { translateSegments(langcode, json);
                    __ready__() } else __loadlanguage__(langcode,
                    lang_url,
                    function(data) { if (data) { TXLIVE_PRIVATE.storage_set(key, data); if (langcode === TXLIVE.getSelectedLanguageCode()) { translateSegments(langcode, data);
                                __ready__() } } else __ready__() })
            }
            TXLIVE.setSelectedLanguageCode(langcode);
            TXLIVE_PRIVATE.storage_set("txlive:selectedlang", langcode)
        } catch (err$24) { TXLIVE.logger.error(err$24) }
    };
    ...
    function setLanguages(languages) {
        try {
            ...
            if (isString(languages.translation)) try { languages.translation = JSON.parse(languages.translation) || [] } catch (err$25) { TXLIVE.logger.error(err$25);
                languages.translation = [] }
            TXLIVE.denormalized_languages = [{ name: languages.source.name, code: languages.source.code, source: true }];
            for (var i = 0; i < languages.translation.length; ++i) TXLIVE.denormalized_languages.push({ name: languages.translation[i].name, code: languages.translation[i].code });
            ...
            setupPicker()
        } catch (err$26) { TXLIVE.logger.error(err$26) }
    }
    TXLIVE.isPageFiltered = function() { return TXLIVE.settings && TXLIVE.settings.filters && TXLIVE_PRIVATE.ignorePath(TXLIVE.settings.filters, window.location.pathname) };
    TXLIVE.detectLanguage =
        function() {
            try {
                var detect_lang = TXLIVE.settings.detectlang,
                    code;
                if (detect_lang && isFunction(detect_lang)) { detect_lang = detect_lang(); if (detect_lang !== true && detect_lang !== false) return detect_lang }
                ...
                if (url.length > 0) { code = TXLIVE.normalizeLangCode(url[0]); if (TXLIVE.hasLanguageCode(code)) return code }
                url = TXLIVE_PRIVATE.getWindowLocation().pathname.split("/");
                if (url.length > 1) { code = TXLIVE.normalizeLangCode(url[1]); if (TXLIVE.hasLanguageCode(code)) return code }
                return TXLIVE_PRIVATE.storage_get("txlive:selectedlang") || TXLIVE_PRIVATE.getBrowserLocale()
            } catch (err$27) { TXLIVE.logger.error(err$27) }
        };
    TXLIVE.getLanguageName = function(langcode) { try { if (!TXLIVE.denormalized_languages) return; var d = TXLIVE.denormalized_languages; for (var i = 0; i < d.length; ++i)
                if (d[i].code === langcode) return d[i].name } catch (err$28) { TXLIVE.logger.error(err$28) } };
    TXLIVE.hasLanguageCode = function(langcode) {
        try {
            ...
            return false
        } catch (err$29) { TXLIVE.logger.error(err$29) }
    };
    ...
    TXLIVE.matchLanguageCode = function(fuzzy_langcode) { try { var stripCode = function(code) { code = code || ""; if (code.indexOf("-") >= 0) code = code.split("-")[0];
                else if (code.indexOf("_") >= 0) code = code.split("_")[0]; return code.toLowerCase() }; if (!TXLIVE.denormalized_languages) return;
            fuzzy_langcode = stripCode(fuzzy_langcode); var d = TXLIVE.denormalized_languages; for (var i = 0; i < d.length; ++i)
                if (stripCode(d[i].code) === fuzzy_langcode) return d[i].code } catch (err$30) { TXLIVE.logger.error(err$30) } };
    TXLIVE.getAllLanguages = function() { return TXLIVE.denormalized_languages };
    TXLIVE.getSourceLanguage = function() { if (TXLIVE.languages) return TXLIVE.languages.source };
    TXLIVE.getSourceLanguageCode = function() { if (TXLIVE.languages && TXLIVE.languages.source) return TXLIVE.languages.source.code; return TXLIVE.__source_language_code };
    TXLIVE.getSelectedLanguageCode = function() { return TXLIVE.selected_lang };
    ...
    TXLIVE.onBeforeTranslatePage = function(fcall) { TXLIVE.__onbeforetranslatepage = TXLIVE.__onbeforetranslatepage || [];
        TXLIVE.__onbeforetranslatepage.push(fcall) };
    TXLIVE.onTranslatePage = function(fcall) { TXLIVE.__ontranslatepage = TXLIVE.__ontranslatepage || [];
        TXLIVE.__ontranslatepage.push(fcall); if (LAST_TRANSLATION_LANG && fcall) callFunctionArray([fcall], LAST_TRANSLATION_LANG) };
    TXLIVE.onFetchLanguages = function(fcall) { TXLIVE.__onfetchlanguages = TXLIVE.__onfetchlanguages || [];
        TXLIVE.__onfetchlanguages.push(fcall); if (TXLIVE.languages && fcall) callFunctionArray([fcall], TXLIVE.denormalized_languages) };
    TXLIVE.onDynamicContent = function(fcall) { TXLIVE.__ondynamiccontent = TXLIVE.__ondynamiccontent || [];
        TXLIVE.__ondynamiccontent.push(fcall) };
    TXLIVE.onError = function(fcall) { TXLIVE.__onerror = TXLIVE.__onerror || [];
        TXLIVE.__onerror.push(fcall) };
    TXLIVE.onReady = function(fcall) {
        if (TXLIVE.ready &&
            fcall) callFunctionArray([fcall], TXLIVE.load_msec);
        else { TXLIVE.__onready = TXLIVE.__onready || [];
            TXLIVE.__onready.push(fcall) }
    };
    TXLIVE.onBeforeTranslate = function(fcall) { TXLIVE.__onbeforetranslate = TXLIVE.__onbeforetranslate || [];
        TXLIVE.__onbeforetranslate.push(fcall) };
    TXLIVE.onAfterTranslate = function(fcall) { TXLIVE.__onaftertranslate = TXLIVE.__onaftertranslate || [];
    ...
    TXLIVE.translateNodes = function(node_array) {
        ...
        var i, j, key,
            s, string, item;
        for (i = 0; i < node_array.length; ++i) { var node = node_array[i]; try { if (!IS_SKIP_PARENT(node)) PARSE_DOM(node, [], PARSER_OPTIONS.DEFAULT) } catch (err$31) { TXLIVE.logger.error(err$31) } }
        var new_segments = [];
                        ...
                        try {
                            if (string) {
                                item.set(item,
                                    string);
                                item.modified = true
                            } else if (item.modified) { item.set(item, s.source_string);
                                item.modified = false }
                        } catch (err$32) { s.elements.splice(j, 1) }
                    }
                    s.translation_string = string || s.source_string
                }
            }
    ...
    TXLIVE.translateNode = function(node) { TXLIVE.translateNodes([node]) };
    ...
    function translate_text_params(text, params) { if (params)
            for (var key in params) text = text.replace(new RegExp("\\{" + key + "\\}", "g"), params[key]); return text }
    TXLIVE.translateText = function(text, params) {
        ...
        var segments = TXLIVE.segments;
        var segment = segments[key];
        if (!segment) { segment = { key: key, source_string: text, tags: ["api"], elements: [] };
            segments[key] = segment;
            callFunctionArray(TXLIVE.__ondynamiccontent, [segment]);
            autocollect_translate_text[key] = segment; if (timer_translate_text) clearTimeout(timer_translate_text);
    ...
    TXLIVE_PRIVATE.revertToSource = function(lang_code) { resetSegments(lang_code) };
    TXLIVE_PRIVATE.useSourceLanguageCode = function(lang_code) { TXLIVE.__source_language_code = lang_code };
    TXLIVE_PRIVATE.parseHTMLBlock = function(html) {
        var root = document.createElement("div");
        root.innerHTML = html;
        NEW_SEGMENTS_DICT = {};
        try { PARSE_DOM(root, [], PARSER_OPTIONS.DEFAULT) } catch (err$33) { TXLIVE.logger.error(err$33) }
        var segments =
            NEW_SEGMENTS_DICT;
        NEW_SEGMENTS_DICT = null;
        return { root: root, segments: segments }
    };
    TXLIVE.segmentHTML = function(html, as_key_value_json) { var segments = TXLIVE_PRIVATE.parseHTMLBlock(html).segments; var json = {},
            key; if (as_key_value_json)
            for (key in segments) json[key] = segments[key].source_string;
        else
            for (key in segments) { var segment = segments[key];
    ...
    TXLIVE.translateHTML = function(html, translations) {
        ...
        if (translations)
            for (var key in segments) { var s = segments[key]; var string = translations[s.key]; if (!string) continue; var j = s.elements.length; while (j--) { var item = s.elements[j]; try { item.set(item, string) } catch (err$34) {} } }
        return parsed_content.root.innerHTML
    };
    TXLIVE_PRIVATE.extractDomain = function(url) { if (!url) return ""; var domain; if (url.indexOf("://") > -1) domain = url.split("/")[2];
        else domain = url.split("/")[0]; return domain };
    TXLIVE.group = TXLIVE_PRIVATE.md5(document.title || "default");
    try { var metas = document.getElementsByTagName("meta"); for (i = 0; i < metas.length; ++i) { var group = metas[i].getAttribute("txlive-group"); if (group && group.length) { TXLIVE.group = TXLIVE_PRIVATE.md5(group); break } } } catch (err$35) { TXLIVE.logger.error(err$35) }
    ...
    TXLIVE_SIDEBAR.delCookie = function(name) { TXLIVE_SIDEBAR.setCookie(name, "", -1) };
    TXLIVE_SIDEBAR.shouldOpen = function() { if (!TXLIVE.settings.api_key && !TXLIVE.settings.mode) return false; var cookie_dict = TXLIVE_SIDEBAR.__cookie; if (TXLIVE.settings.sidebar || TXLIVE_SIDEBAR.getCookie(cookie_dict.key) === cookie_dict.value) return true; var params = TXLIVE_SIDEBAR.getLocationParams(); for (var key in params)
            if (key.toLowerCase() === SIDEBAR_URL_TRIGGER) return true;
        return false };
    TXLIVE_SIDEBAR.getLocationParams =
        function() { var search_string = TXLIVE_PRIVATE.getWindowLocation().search.substr(1); var params_array = search_string.split("&"); var return_value = {}; for (var i = 0; i < params_array.length; i++) { var param_string = params_array[i]; if (param_string.indexOf("=") != -1) { var param_string_split = param_string.split("="); var key = param_string_split[0],
                        value = param_string_split[1];
                    return_value[key] = value } else return_value[param_string] = null } return return_value };
    TXLIVE_SIDEBAR.load = function(callback) {
        ...
        TXLIVE.doCORSRequest(sidebar_url, "GET", "", function(html) {
            ...
            for (i = links.length; i--;) { var rel = links[i].getAttribute("rel"),
                    href = links[i].getAttribute("href"); if (href && rel && rel.indexOf("stylesheet") >= 0) links[i].setAttribute("href", TXLIVE.assetUrl(href, TXLIVE.settings.assets_base_url));
                head.appendChild(links[i].parentNode.removeChild(links[i])) }
            while (div.firstChild) { var child = div.firstChild;
            ...
            function consume_scripts() {
                ...
                else { TXLIVE.loadScript(null, null, script.innerHTML, script.attributes);
                    consume_scripts() }
            }
            consume_scripts()
        })
    ...
    TXLIVE_PRIVATE.getSegmentsXPaths = function() { var xpaths = {}; for (var key in TXLIVE.segments) { var segment = TXLIVE.segments[key]; for (var j = 0; j < segment.elements.length; ++j) { var xpath = TXLIVE_PRIVATE.getXPath(segment.elements[j].node); if (xpath) xpaths[xpath] = segment.key } } return xpaths };

    function __traverseready__() {
        if (TXLIVE.traverse_ready) return;
        TXLIVE.traverse_ready = true;
        var i, key, tag;
        try { SKIP_TAGS_USER = {}; if (TXLIVE.settings.ignore_tags && TXLIVE.settings.ignore_tags.length)
                for (i = 0; i < TXLIVE.settings.ignore_tags.length; ++i) { tag = TXLIVE.settings.ignore_tags[i]; if (tag.length) SKIP_TAGS_USER[tag] = true } } catch (err$37) { TXLIVE.logger.error(err$37) }
        try { if (TXLIVE.settings.enable_tags && TXLIVE.settings.enable_tags.length)
                for (i = 0; i < TXLIVE.settings.enable_tags.length; ++i) { tag = TXLIVE.settings.enable_tags[i]; if (tag.length) { delete SKIP_TAGS[tag];
                        delete SKIP_TAGS_USER[tag] } } } catch (err$38) { TXLIVE.logger.error(err$38) }
        try {
            SKIP_CLASS_USER = {};
            if (TXLIVE.settings.ignore_class && TXLIVE.settings.ignore_class.length)
                for (i = 0; i < TXLIVE.settings.ignore_class.length; ++i) { var cls = TXLIVE.settings.ignore_class[i]; if (cls.length) SKIP_CLASS_USER[cls] = true }
        } catch (err$39) { TXLIVE.logger.error(err$39) }
        try {
        ...
        } catch (err$40) { TXLIVE.logger.error(err$40) }
        try { __init_mutators__() } catch (err$41) { TXLIVE.logger.error(err$41) }
    }

    function __reload__() {
        var previous_lang = null;
        if (LAST_TRANSLATION_JSON) { previous_lang = LAST_TRANSLATION_LANG; var source_lang = TXLIVE.getSourceLanguage(); if (source_lang && source_lang.code) TXLIVE.translateTo(source_lang.code) }
    ...
    function __loadManifest__() {
        ...
        window.transifex_manifest = function(manifest) {
            if (!manifest) { TXLIVE.logger.error("Empty manifest");
                ...
                if (detected_langcode)
                    for (var i = 0; i < languages.translation.length; ++i)
                        if (languages.translation[i].code ===
                            detected_langcode) { var key = TXLIVE_PRIVATE.apiScopedKey(detected_langcode + "@" + languages.timestamp); if (TXLIVE_PRIVATE.storage_get(key)) break;
                            else { __loadlanguage__(detected_langcode, languages.translation[i].url, function(data) { TXLIVE_PRIVATE.storage_set(key, data);
                                    __init__() }); return } }
            }
            TXLIVE_PRIVATE.manifest_ready = true;
            __init__()
        };
        TXLIVE.loadScript(base_url + "/manifest.jsonp", function() { if (!TXLIVE_PRIVATE.manifest) { TXLIVE_PRIVATE.manifest = {};
                __init__() } })
    }
    ...
    function __loadlanguage__(langcode, url, callback) {
        var lang_loaded =
            false;
        window["transifex_lang_" + TXLIVE_PRIVATE.escapeLanguageCode(langcode)] = function(data) { lang_loaded = true;
            callback(data) };
        TXLIVE.loadScript(url, function() { if (!lang_loaded && TXLIVE.__onerror) callFunctionArray(TXLIVE.__onerror, "[ERR2] Cannot load translation url: " + url); if (!lang_loaded && callback) callback() })
    }

    function __init__() {
        if (!TXLIVE_PRIVATE._domready) return;
        try { benchmark = (new Date).getTime() } catch (err$42) {}
        if (TXLIVE.settings.prerender && !TXLIVE.ready) window.prerenderReady = false;
        if (!TXLIVE.settings.api_key ||
            TXLIVE.live_noop) { __traverseready__();
            __ready__(); return }
        ...
        if (manifest) {
            if (manifest.settings) {
                ...
                if (settings) try { if (JSON.stringify(settings) !== JSON.stringify(manifest.settings)) reload = true } catch (err$43) { TXLIVE.logger.error(err$43) }
            }
        ...
        } else if (manifest) { __traverseready__();
            __ready__() }
    }
    TXLIVE.init = function() { TXLIVE_PRIVATE._domready = true;
        __loadManifest__();
        __init__() };
    bindReady(function() { if (!TXLIVE.settings.manual_init) TXLIVE.init() });
    bindLoad(function() { TXLIVE.autocollect_ready = true;
        autocollectConsume() });
